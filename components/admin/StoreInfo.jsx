    ...
    return (
        <div className="flex-1 space-y-2 text-sm">
            {store.logo ? (
                ...
                <div className="max-w-20 max-h-20 object-contain shadow rounded-full max-sm:mx-auto">
                    <Image width={100} height={100} src="/placeholder.png" alt={store.name} className="w-full h-full object-cover" />
                </div>
            )}
